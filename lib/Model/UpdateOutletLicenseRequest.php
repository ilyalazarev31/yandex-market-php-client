...
class UpdateOutletLicenseRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'licenses' => '\YandexMarketApi\Model\OutletLicenseDTO[]'
    ];
    ...
    */
     ...
     * Gets licenses
     *
     * @return \YandexMarketApi\Model\OutletLicenseDTO[]
     */
     ...
     * Sets licenses
     *
     * @param \YandexMarketApi\Model\OutletLicenseDTO[] $licenses Список лицензий. Обязательный параметр, должен содержать информацию хотя бы об одной лицензии.
     *
     * @return self
     */
