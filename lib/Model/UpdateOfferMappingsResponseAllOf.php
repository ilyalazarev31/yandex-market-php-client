    ...
    */
    ...
    public function setResults($results)
    {
        ...
        if (!is_null($results) && (count($results) < 1)) {
            throw new \InvalidArgumentException('invalid length for $results when calling UpdateOfferMappingsResponseAllOf., number of items must be greater than or equal to 1.');
        }
