...
class ChatMessageDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'message_id' => 'int',
        'created_at' => '\DateTime',
        'sender' => '\YandexMarketApi\Model\ChatMessageSenderType',
        'message' => 'string',
        'payload' => '\YandexMarketApi\Model\ChatMessagePayloadDTO[]'
    ];
    ...
    */
     ...
     * Gets sender
     *
     * @return \YandexMarketApi\Model\ChatMessageSenderType
     */
     ...
     * Sets sender
     *
     * @param \YandexMarketApi\Model\ChatMessageSenderType $sender sender
     *
     * @return self
     */
     ...
     * Gets payload
     *
     * @return \YandexMarketApi\Model\ChatMessagePayloadDTO[]|null
     */
     ...
     * Sets payload
     *
     * @param \YandexMarketApi\Model\ChatMessagePayloadDTO[]|null $payload Информация о приложенных к сообщению файлах.  Необязательный параметр, если возвращается параметр `message`.
     *
     * @return self
     */
