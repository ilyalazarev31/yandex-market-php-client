...
class CampaignQualityRatingDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'campaign_id' => 'int',
        'ratings' => '\YandexMarketApi\Model\QualityRatingDTO[]'
    ];
    ...
    */
     ...
     * Gets ratings
     *
     * @return \YandexMarketApi\Model\QualityRatingDTO[]
     */
     ...
     * Sets ratings
     *
     * @param \YandexMarketApi\Model\QualityRatingDTO[] $ratings Список значений индекса качества.
     *
     * @return self
     */
