...
class UpdatePromoOffersRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'promo_id' => 'string',
        'offers' => '\YandexMarketApi\Model\UpdatePromoOfferDTO[]'
    ];
    ...
    */
     ...
     * Gets offers
     *
     * @return \YandexMarketApi\Model\UpdatePromoOfferDTO[]
     */
     ...
     * Sets offers
     *
     * @param \YandexMarketApi\Model\UpdatePromoOfferDTO[] $offers Товары, которые необходимо добавить в акцию или цены которых нужно изменить.
     *
     * @return self
     */
