...
/**
 * RegionWithChildrenDTOAllOf Class Doc Comment
 *
 * @category Class
 * @package  YandexMarketApi
 * @author   OpenAPI Generator team
 ...
 */
class RegionWithChildrenDTOAllOf implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RegionWithChildrenDTO_allOf';
    ...
    */
    ...
    public function setChildren($children)
    {
        ...
        if (!is_null($children) && (count($children) < 1)) {
            throw new \InvalidArgumentException('invalid length for $children when calling RegionWithChildrenDTOAllOf., number of items must be greater than or equal to 1.');
        }
