...
/**
 * UpdateOfferContentResponseAllOf Class Doc Comment
 *
 * @category Class
 * @package  YandexMarketApi
 * @author   OpenAPI Generator team
 ...
 */
class UpdateOfferContentResponseAllOf implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UpdateOfferContentResponse_allOf';
    ...
    protected static $openAPITypes = [
        'results' => '\YandexMarketApi\Model\UpdateOfferContentResultDTO[]'
    ];
    ...
    */
     ...
     * Gets results
     *
     * @return \YandexMarketApi\Model\UpdateOfferContentResultDTO[]|null
     */
    ...
    public function setResults($results)
    {
        ...
        if (!is_null($results) && (count($results) < 1)) {
            throw new \InvalidArgumentException('invalid length for $results when calling UpdateOfferContentResponseAllOf., number of items must be greater than or equal to 1.');
        }
