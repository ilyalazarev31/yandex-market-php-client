...
class WarningPromoOfferUpdateDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'offer_id' => 'string',
        'warnings' => '\YandexMarketApi\Model\PromoOfferUpdateWarningDTO[]'
    ];
    ...
    */
     ...
     * Gets warnings
     *
     * @return \YandexMarketApi\Model\PromoOfferUpdateWarningDTO[]
     */
     ...
     * Sets warnings
     *
     * @param \YandexMarketApi\Model\PromoOfferUpdateWarningDTO[] $warnings Предупреждения, которые появились при добавлении товара в акцию или изменении его цен.
     *
     * @return self
     */
