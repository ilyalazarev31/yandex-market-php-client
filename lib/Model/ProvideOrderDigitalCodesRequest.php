...
class ProvideOrderDigitalCodesRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'items' => '\YandexMarketApi\Model\OrderDigitalItemDTO[]'
    ];
    ...
    */
     ...
     * Gets items
     *
     * @return \YandexMarketApi\Model\OrderDigitalItemDTO[]
     */
     ...
     * Sets items
     *
     * @param \YandexMarketApi\Model\OrderDigitalItemDTO[] $items Список проданных товаров.  Для товара с одинаковым `id` передавайте один элемент и массив `codes` по количеству ключей.
     *
     * @return self
     */
