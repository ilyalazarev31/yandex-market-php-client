...
/**
 * PriceWithDiscountDTOAllOf Class Doc Comment
 *
 * @category Class
 * @package  YandexMarketApi
 * @author   OpenAPI Generator team
 ...
 */
class PriceWithDiscountDTOAllOf implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PriceWithDiscountDTO_allOf';
    ...
    */
    ...
    public function setDiscountBase($discount_base)
    {
        ...
        if (($discount_base <= 0)) {
            throw new \InvalidArgumentException('invalid value for $discount_base when calling PriceWithDiscountDTOAllOf., must be bigger than 0.');
        }
