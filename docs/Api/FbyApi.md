...
| [**generatePricesReport()**](FbyApi.md#generatePricesReport) | **POST** /v2/reports/prices/generate | Отчет «Цены на рынке» |
...
| [**getFulfillmentWarehouses()**](FbyApi.md#getFulfillmentWarehouses) | **GET** /v2/warehouses | Идентификаторы складов Маркета |
...
| [**getOfferMappingEntries()**](FbyApi.md#getOfferMappingEntries) | **GET** /v2/campaigns/{campaignId}/offer-mapping-entries | Список товаров в каталоге |
...
| [**getSuggestedOfferMappingEntries()**](FbyApi.md#getSuggestedOfferMappingEntries) | **POST** /v2/campaigns/{campaignId}/offer-mapping-entries/suggestions | Рекомендованные карточки для товаров |
| [**getSuggestedOfferMappings()**](FbyApi.md#getSuggestedOfferMappings) | **POST** /v2/businesses/{businessId}/offer-mappings/suggestions | Просмотр карточек на Маркете, которые подходят вашим товарам |
...
| [**submitReturnDecision()**](FbyApi.md#submitReturnDecision) | **POST** /v2/campaigns/{campaignId}/orders/{orderId}/returns/{returnId}/decision/submit | Передача и подтверждение решения по возврату |
...
| [**updateOfferMappingEntries()**](FbyApi.md#updateOfferMappingEntries) | **POST** /v2/campaigns/{campaignId}/offer-mapping-entries/updates | Добавление и редактирование товаров в каталоге |
...
```php
generateBarcodesReport($generate_barcodes_report_request): \YandexMarketApi\Model\GenerateReportResponse
```
...
$generate_barcodes_report_request = new \YandexMarketApi\Model\GenerateBarcodesReportRequest(); // \YandexMarketApi\Model\GenerateBarcodesReportRequest
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **generate_barcodes_report_request** | [**\YandexMarketApi\Model\GenerateBarcodesReportRequest**](../Model/GenerateBarcodesReportRequest.md)|  | |
...
```php
getFulfillmentWarehouses($campaign_id): \YandexMarketApi\Model\GetFulfillmentWarehousesResponse
```
