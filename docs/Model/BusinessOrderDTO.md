...
**program_type** | [**\YandexMarketApi\Model\SellingProgramType**](SellingProgramType.md) |  | [optional]
...
**items** | [**\YandexMarketApi\Model\BusinessOrderItemDTO[]**](BusinessOrderItemDTO.md) | Список товаров в заказе. |
**prices** | [**\YandexMarketApi\Model\OrderPriceDTO**](OrderPriceDTO.md) |  | [optional]
**delivery** | [**\YandexMarketApi\Model\BusinessOrderDeliveryDTO**](BusinessOrderDeliveryDTO.md) |  |
**services** | [**\YandexMarketApi\Model\BusinessOrderServicesDTO**](BusinessOrderServicesDTO.md) |  | [optional]
**buyer_type** | [**\YandexMarketApi\Model\OrderBuyerType**](OrderBuyerType.md) |  | [optional]
